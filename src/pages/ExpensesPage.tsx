...
const categoryIcons: Record<string, string> = {
    ...
    'Muhasebe': 'account_balance', 'Kurye': 'local_shipping', 'Tedarikçi': 'store', 'Diğer': 'more_horiz'
};

const expenseCategories = ['Kira', 'Elektrik', 'İnternet', 'Maaş', 'Stok', 'Mutfak', 'Fatura', 'Muhasebe', 'Kurye', 'Tedarikçi', 'Diğer'];
