...
export interface AppUser {
  ...
  pinCode: string;
  role: UserRole;
  branchId: string | null;  // owner için null, worker için şube ID'si
  isActive: boolean;
  createdAt: string;
}
...
export interface BranchSettings {
  id: string;
  branchId: string;
  showPurchasePrice: boolean;  // false ise çalışan alış fiyatını göremez
  storeName: string;
  storePhone?: string;
}

// Hangi roller hangi sayfaları görebilir
export const WORKER_ALLOWED_PAGES = [
  'sales',
  'products',
  'repairs',
  'repairParts',
